...
window.addEventListener("DOMContentLoaded", async () => {
  ...
  // GLOBAL VARIABLES
  var cameraState = localStorage.getItem("@hmo_use_camera") ?? false;
  var audioState = localStorage.getItem("@hmo_use_audio") ?? false;
  ...
  async function startRecording() {
    try {
      ...
      if (defaultScreen === "current_tab") {
        // Capture current tab
        const streamId = localStorage.getItem("@hmo_tab_streamId");
